class Tournament < ActiveRecord::Base
  ...
  def initialize_bracket
    ...
    self.bracket[0][0..initial_round_size-1] = tournament_members.first(initial_round_size)
    self.bracket[1][filter_slots..-1] = tournament_members[initial_round_size..-1]
  end
end
