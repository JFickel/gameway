...
(function() {
  $(function() {
    return $('#event_start_date').datepicker({
      dateFormat: 'yy-mm-dd'
    });
  });
  ...
  $(function() {
    $('.tournament-search #query').typeahead({
      ...
      remote: {
        ...
        filter: function(parsedResponse) {
          return $.map(parsedResponse.tournaments, function(tournament, i) {
            var datum;
            datum = {
    ...
    $('.team-search #query').typeahead({
      ...
      remote: {
        ...
        filter: function(parsedResponse) {
          return $.map(parsedResponse.teams, function(team, i) {
            var datum;
            datum = {
              value: team.name,
              tokens: team.name,
    ...
    $('.group-search #query').typeahead({
      ...
      remote: {
        ...
        filter: function(parsedResponse) {
          return $.map(parsedResponse.groups, function(group, i) {
            var datum;
            return datum = {
              value: group.name,
    ...
    $('.user-search #user_query').typeahead({
      ...
      remote: {
        ...
        filter: function(parsedResponse) {
          return $.map(parsedResponse.users, function(user, i) {
            var datum;
            datum = {
              value: user.username,
    ...
    $('.game-search').typeahead({
      ...
      remote: {
        ...
        filter: function(parsedResponse) {
          return $.map(parsedResponse.games, function(game, i) {
            var datum;
            datum = {
              value: game.name,
              tokens: [game.name],
    ...
    $('.add-auxiliary').on("submit", ".user-search", function(event) {
      var array, tournament_id;
      event.preventDefault();
      ...
      return $.ajax({
        ...
        success: function(data) {
          ...
          return $('.auxiliary-candidates').append(output);
        }
      });
    });
    return $('.add-team-member').on("submit", ".user-search", function(event) {
      var first, mid, team_id, _i, _ref;
      event.preventDefault();
      _ref = $('.edit_team').attr('action').split("/"), first = _ref[0], mid = 3 <= _ref.length ? __slice.call(_ref, 1, _i = _ref.length - 1) : (_i = 1, []), team_id = _ref[_i++];
      return $.ajax({
        type: 'GET',
        url: '/users',
        dataType: 'json',
        ...
        success: function(data) {
          ...
          return $('.team-member-candidates').append(output);
        }
      });
    });
  });
...
window.analytics.load("s328ur39yd"),
...
(function() {
  ...
  $(function() {
    var setTypeAhead;
    $('.add-affiliation').on("submit", ".user-search", function(event) {
      var first, mid, team_id, _i, _ref;
      event.preventDefault();
      _ref = $('.edit_team').attr('action').split("/"), first = _ref[0], mid = 3 <= _ref.length ? __slice.call(_ref, 1, _i = _ref.length - 1) : (_i = 1, []), team_id = _ref[_i++];
      return $.ajax({
        ...
        success: function(data) {
          ...
          return $('.affiliation-candidates').append(output);
        }
      });
    });
    setTypeAhead = function(table, template) {
      $('.affiliation-search #affiliation_query').typeahead('destroy');
      return $('.affiliation-search #affiliation_query').typeahead({
        name: 'affiliations',
        remote: {
    ...
    $('.affiliation-search-filter').on("click", ".groups-filter", function() {
      var table, template;
      table = "groups";
      template = "<strong>{{value}}</strong>{{kind}}</p>";
      return setTypeAhead(table, template);
    });
    $('.affiliation-search-filter').on("click", ".teams-filter", function() {
      var table, template;
      table = "teams";
      template = "<img src={{avatar_url}}><p><strong>  {{value}}</strong></p>";
      return setTypeAhead(table, template);
    });
    return $('.affiliation-search-filter').on("click", ".tournaments-filter", function() {
      var table, template;
      table = "tournaments";
      template = "<p><strong>{{value}}</strong></p>";
      return setTypeAhead(table, template);
...
(function() {
  $(function() {
    var BracketView, bracketView, current_opponent, team, tournament, tournamentSerializerJSON, user;
    ...
    $('.tournament-delete-btn').click(function() {
      return confirm("Are you sure you want to delete this tournament?");
    });
    BracketView = (function() {
      function BracketView(options) {
        this.moderatorStatus = options.moderatorStatus, this.matchHeight = options.matchHeight, this.matchPadding = options.matchPadding, this.matchWidth = options.matchWidth, this.matchBorder = options.matchBorder;
      }

      BracketView.prototype.determineClassRound = function(round_index, round, self) {
      ...
      BracketView.prototype.renderBracket = function(tournament) {
        var output, self;
        this.tournament = tournament;
        this.bracket = this.tournament.ordered_bracket;
        this.mode = this.tournament.mode;
        $('.participants').hide();
        $('.tournament-sign-up-btn').hide();
        output = "";
        self = this;
        $.each(this.bracket, function(round_index, round) {
          output += self.determineClassRound(round_index, round, self);
          $.each(round, function(match_index, match) {
            output += "<li><div class='match'>";
            output += self.determineHeader(round_index, round, match_index, self);
            if (match !== null) {
              if (self.mode === "individual") {
                $.each(match.user_showings, function(user_showing_index, user_showing) {
                  if (self.moderatorStatus === "true") {
                    ...
                    return output += "<button class='advance-slot' data-position='[" + round_index + "," + match_index + "," + user_showing_index + "]'>" + user_showing.username + "</button></div>";
                  } else if (self.moderatorStatus === "false") {
                    return output += "<a href='/users/" + user_showing.user_id + "' class='slot' data-model-id='" + user_showing.user_id + "'>" + user_showing.username + "</a>";
                  }
                });
              } else if (self.mode === "team") {
                $.each(match.team_showings, function(team_showing_index, team_showing) {
                  if (self.moderatorStatus === "true") {
                    ...
                    return output += "<button class='advance-slot' data-position='[" + round_index + "," + match_index + "," + team_showing_index + "]'>" + team_showing.team_name + "</button></div>";
                  } else if (self.moderatorStatus === "false") {
                    return output += "<a href= '/teams/" + team_showing.team_id + "' class='slot' data-model-id='" + team_showing.team_id + "'>" + team_showing.team_name + "</a>";
                  }
                });
              }
            }
      ...
      BracketView.prototype.determineHeader = function(round_index, round, match_index, self) {
        if (round_index === self.bracket.length - 1) {
      ...
      BracketView.prototype.setStyles = function() {
        var matchTotalHeight, self;
        matchTotalHeight = this.matchHeight + (2 * this.matchPadding[0]) + 2 * this.matchBorder;
        self = this;
        return $.each(this.bracket, function(round_index, round) {
          var correctedHeight, correctedPadding, marginBottom, marginTop;
          if (round_index === 0) {
          ...
          if (round_index > 1 && round_index !== self.bracket.length - 1) {
            ...
            return $(".round-" + (round.length * 2) + " li").css('padding', "" + (((correctedHeight - 70) / 2) + correctedPadding) + "px 10px");
          }
        });
      };
    ...
    $('.bracket').on('mouseenter', '.slot', function() {
      var user_id;
      user_id = $(this).data('model-id');
      return $.map($('.round').find(".slot[data-model-id='" + user_id + "']").get(), function(slot, i) {
        return $(slot).addClass("highlighted");
      });
    });
    $('.bracket').on('mouseleave', '.slot', function() {
      var user_id;
      user_id = $(this).data('model-id');
      return $.map($('.round').find(".slot[data-model-id='" + user_id + "']").get(), function(slot, i) {
        return $(slot).removeClass("highlighted");
      });
    });
    $('.bracket').on('mouseenter', '.delete-slot-btn', function() {
      var user_id;
    ...
    $('.bracket').on('mouseleave', '.delete-slot-btn', function() {
      return $(this).parent().removeClass("delete-highlight");
    });
    $('.bracket').on('click', 'button.advance-slot', function() {
      ...
      return $.ajax({
        ...
        success: function(data) {
          $('.bracket').empty();
          return bracketView.renderBracket(data.tournament);
        }
      });
    });
    $('.bracket').on('click', '.delete-slot-btn', function() {
    ...
    if ($('#tournament_open').val() === "true") {
      $('#tournament_open_applications').hide();
      $('#tournament_open_applications').val("false");
    } else if ($('#tournament_open').val() === "false") {
      $('#tournament_open_applications').show();
    }
    $('.new_tournament').on('change', '#tournament_open', function() {
      if ($('#tournament_open').val() === "true") {
        $('#tournament_open_applications').hide();
        return $('#tournament_open_applications').val("false");
      } else if ($('#tournament_open').val() === "false") {
        return $('#tournament_open_applications').show();
      }
    });
    return $('.edit_tournament').on('change', '#tournament_open', function() {
      if ($('#tournament_open').val() === "true") {
        $('#tournament_open_applications').hide();
        return $('#tournament_open_applications').val("false");
      } else if ($('#tournament_open').val() === "false") {
...
(function() {
  $(document).ready(function() {
    $('form.new_starcraft2_account').on('ajax:success', function(evnt, data, status, xhr) {
      $('.link-accounts .flash-messages').empty();
      return $('.link-accounts .flash-messages').append("<div class='link-account-flash'>" + data.message + "</div>");
    });
    $('form.new_starcraft2_account').on('ajax:error', function(evnt, xhr, status, error) {
      $('.link-accounts .flash-messages').empty();
      return $('.link-accounts .flash-messages').append("<div class='link-account-flash'>Something went wrong adding your Starcraft 2 Account</div>");
    });
    $('form.edit_starcraft2_account').on('ajax:success', function(evnt, data, status, xhr) {
      $('.link-accounts .flash-messages').empty();
      return $('.link-accounts .flash-messages').append("<div class='link-account-flash'>" + data.message + "</div>");
    });
    $('form.edit_starcraft2_account').on('ajax:error', function(evnt, xhr, status, error) {
      $('.link-accounts .flash-messages').empty();
      return $('.link-accounts .flash-messages').append("<div class='link-account-flash'>Something went wrong updating your Starcraft 2 Account</div>");
    });
    $('form.new_lol_account').on('ajax:success', function(evnt, data, status, xhr) {
      $('.link-accounts .flash-messages').empty();
      return $('.link-accounts .flash-messages').append("<div class='link-account-flash'>" + data.message + "</div>");
    });
    $('form.new_lol_account').on('ajax:error', function(evnt, xhr, status, error) {
      $('.link-accounts .flash-messages').empty();
      return $('.link-accounts .flash-messages').append("<div class='link-account-flash'>Something went wrong adding your Starcraft 2 Account</div>");
    });
    $('form.edit_lol_account').on('ajax:success', function(evnt, data, status, xhr) {
      $('.link-accounts .flash-messages').empty();
      return $('.link-accounts .flash-messages').append("<div class='link-account-flash'>" + data.message + "</div>");
    });
    $('form.edit_lol_account').on('ajax:error', function(evnt, xhr, status, error) {
      $('.link-accounts .flash-messages').empty();
      return $('.link-accounts .flash-messages').append("<div class='link-account-flash'>Something went wrong updating your Starcraft 2 Account</div>");
    });
    $('form.new_twitch_account').on('ajax:success', function(evnt, data, status, xhr) {
      $('.link-accounts .flash-messages').empty();
      return $('.link-accounts .flash-messages').append("<div class='link-account-flash'>" + data.message + "</div>");
    });
    $('form.new_twitch_account').on('ajax:error', function(evnt, xhr, status, error) {
      $('.link-accounts .flash-messages').empty();
      return $('.link-accounts .flash-messages').append("<div class='link-account-flash'>Something went wrong adding your Starcraft 2 Account</div>");
    });
    $('form.edit_twitch_account').on('ajax:success', function(evnt, data, status, xhr) {
      $('.link-accounts .flash-messages').empty();
      return $('.link-accounts .flash-messages').append("<div class='link-account-flash'>" + data.message + "</div>");
    });
    return $('form.edit_twitch_account').on('ajax:error', function(evnt, xhr, status, error) {
      $('.link-accounts .flash-messages').empty();
      return $('.link-accounts .flash-messages').append("<div class='link-account-flash'>Something went wrong updating your Starcraft 2 Account</div>");
    });
  });
