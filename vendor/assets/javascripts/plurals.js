(function(globals) {
  ...
  defineLanguageRule(['az', 'bm', 'my', 'zh', 'dz', 'ka', 'hu', 'ig', 'id', 'ja', 'jv', 'kea', 'kn', 'km', 'ko', 'ses', 'lo', 'kde', 'ms', 'fa', 'root', 'sah', 'sg', 'ii', 'th', 'bo', 'to', 'tr', 'vi', 'wo', 'yo'], function(n) {
    return Other;
  });

  defineLanguageRule(['gv'], function(n) {
    if (isAmong(n % 10, [1, 2]) || n % 20 === 0) {
      return One;
    }
    return Other;
  });
  ...
  defineLanguageRule(['ak', 'am', 'bh', 'fil', 'guw', 'hi', 'ln', 'mg', 'nso', 'tl', 'ti', 'wa'], function(n) {
    return n === 0 || n === 1 ? One : Other;
  });

  defineLanguageRule(['af', 'sq', 'eu', 'bem', 'bn', 'brx', 'bg', 'ca', 'chr', 'cgg', 'da', 'dv', 'nl', 'en', 'eo', 'et', 'ee', 'fo', 'fi', 'fur', 'gl', 'lg', 'de', 'el', 'gu', 'ha', 'haw', 'he', 'is', 'it', 'kl', 'kk', 'ku', 'lb', 'ml', 'mr', 'mas', 'mn', 'nah', 'ne', 'no', 'nb', 'nn', 'nyn', 'or', 'om', 'pap', 'ps', 'pt', 'pa', 'rm', 'ssy', 'saq', 'xog', 'so', 'es', 'sw', 'sv', 'gsw', 'syr', 'ta', 'te', 'tk', 'ur', 'wae', 'fy', 'zu'], function(n) {
  ...
  defineLanguageRule(['kw', 'smn', 'iu', 'ga', 'smj', 'se', 'smi', 'sms', 'sma'], function(n) {
    if (n === 1) {
      return One;
    }
    if (n === 2) {
  ...
  defineLanguageRule(['be', 'bs', 'hr', 'ru', 'sr', 'sh', 'uk'], function(n) {
    var mod10 = n % 10,
      mod100 = n % 100;
    ...
    if (isAmong(mod10, [2, 3, 4]) && !isAmong(mod100, [12, 13, 14])) {
      return Few;
    }

    if (isAmong(mod10, [0, 5, 6, 7, 8, 9]) || isAmong(mod100, [11, 12, 13, 14])) {
      return Many;
    }
  ...
  defineLanguageRule(['pl'], function(n) {
    ...
    if (isAmong(mod10, [0, 1, 5, 6, 7, 8, 9]) || isAmong(mod100, [12, 13, 14])) {
      return Many;
    }
  ...
  defineLanguageRule(['lt'], function(n) {
    ...
    if (isInt(n) && mod10 >= 2 && mod10 <= 9 && mod100 >= 12 && mod100 <= 19) {
      return Few;
    }
  ...
  defineLanguageRule(['mo', 'ro'], function(n) {
    ...
    if (n === 0 || (isInt(n) && mod100 >= 1 && mod100 <= 19)) {
      return Few;
    }
  ...
  defineLanguageRule(['mt'], function(n) {
    ...
    var mod100 = n % 100;
    if (isInt(mod100) && mod100 >= 2 && mod100 <= 10) {
      return Few;
    }
    if (isInt(mod100) && mod100 >= 11 && mod100 <= 19) {
      return Many;
    }
    return Other;
  });
  ...
  defineLanguageRule(['ar'], function(n) {
    ...
    var mod100 = n % 100;
    if (isInt(mod100) && mod100 >= 3 && mod100 <= 10) {
      return Few;
    }
    if (isInt(mod100) && mod100 >= 11 && mod100 <= 99) {
      return Many;
    }
    return Other;
  });
  ...
  CLDR.pluralForm = function(count, language) {
    if (count == null) {
      throw new Error("CLDR.pluralForm requires a count");
    }
    language = language || CLDR.defaultLanguage;
    if (language == null) {
      throw new Error("CLDR.pluralForm requires a language");
    }
    language = language.replace(/^(\w\w\w?)-?.*/, "$1");
    if (Data[language] == null) {
      throw new Error("No CLDR pluralization information for " + language);
    }
